        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-6">
            <div class="image-wrapper">
              <img src="{{ asset('frontend/assets/imgs/campus-5.png') }}" alt="Campus Overview" class="img-fluid">
    ...
    <section id="testimonials" class="testimonials section light-background">
      ...
      <div class="container">
        ...
        <div class="testimonials-slider swiper init-swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
          ...
          <div class="swiper-wrapper" id="swiper-wrapper-77f2b02b5e7746f8" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-3888px, 0px, 0px); transition-delay: 0ms;">
          ...
          <div class="swiper-slide swiper-slide-next" role="group" aria-label="4 / 4" data-swiper-slide-index="3" style="width: 1296px;">
            ...
            </div><div class="swiper-slide" role="group" aria-label="1 / 4" data-swiper-slide-index="0" style="width: 1296px;">
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
            ...
            </div><div class="swiper-slide swiper-slide-prev" role="group" aria-label="2 / 4" data-swiper-slide-index="1" style="width: 1296px;">
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="{{ asset('frontend/assets/imgs/person-f-8.png') }}" class="profile-img" alt="">
                      <div class="profile-info">
                        <h3>Sara Wilsson</h3>
                        <span>Designer</span>
                      </div>
            ...
            </div><div class="swiper-slide swiper-slide-active" role="group" aria-label="3 / 4" data-swiper-slide-index="2" style="width: 1296px;">
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    <h2>
          ...
          <div class="swiper-navigation w-100 d-flex align-items-center justify-content-center">
            <div class="swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-77f2b02b5e7746f8"></div>
            <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-77f2b02b5e7746f8"></div>
          </div>
            ...
            <div class="content-wrapper">
              ...
              <div class="highlight-stats">
                <div class="stat-group">
                  <div class="stat-item">
                    <span class="number purecounter" data-purecounter-start="0" data-purecounter-end="25000" data-purecounter-duration="0">25000</span>
                    <span class="label">Active Learners</span>
                  </div>
                  <div class="stat-item">
                    <span class="number purecounter" data-purecounter-start="0" data-purecounter-end="200" data-purecounter-duration="0">200</span>
          ...
          <div class="col-lg-7">
            <div class="visual-section">
              <div class="main-image-container">
                <img src="{{ asset('frontend/assets/imgs/students-1.png') }}" alt="Students Learning" class="main-image">
