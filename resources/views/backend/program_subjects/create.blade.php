            ...
            @endforeach
              ...
              <div class="col-md-6">
                <div class="card card-primary card-outline mb-4">
                  ...
                  <form method="post" action="{{ route('program-subject.store') }}">
                    @csrf
                    <div class="card-body">

                   <div class="mb-3">
                      <label class="form-label" for="program_id">Select</label>
                   ...
                   <div class="mb-3">
                      <label class="form-label" for="subject_id">Select</label>
